...
{
public:
    DS18B20(bool crcOn, bool useAddr, bool parasitic, PinName pin, DEBUG_DEC);
    
    virtual void setResolution(eResolution resln, DEBUG_DEC);
    
protected:
    virtual float calculateTemperature(BYTE* data, DEBUG_DEC);
};
