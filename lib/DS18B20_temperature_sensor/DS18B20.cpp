...
DS18B20::DS18B20(bool crcOn, bool useAddr, bool parasitic, PinName pin, DEBUG_IMP) : 
    OneWireThermometer(crcOn, useAddr, parasitic, pin, DS18B20_ID)
{
    DEBUG_PRN(("\r\nConstructed DS18B20 at pin %i.", pin));
}

void DS18B20::setResolution(eResolution resln, DEBUG_IMP)
{
...
float DS18B20::calculateTemperature(BYTE* data, DEBUG_IMP)
{
    bool signBit = false;
    ...
    // Clear first bit because of weird bug where this bit is somehow high
