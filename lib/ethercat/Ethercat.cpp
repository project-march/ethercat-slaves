...
#define DEBUG_PRN(fmt)                                                                                                 \
  if ((pc != NULL) & (debugLevel > 0))                                                                                 \
  pc->printf fmt
...
// Constructors
Ethercat::Ethercat(PinName mosi, PinName miso, PinName sclk, PinName nChipSelect, int PDORXsize, int PDOTXsize,
                   DEBUG_IMP)
{
  ...
  DEBUG_PRN(("\r\n\tmosi = %i.\r\n\tmiso = %i.\r\n\tsclk = %i.\r\n\tnCS = %i.", mosi, miso, sclk, nChipSelect));
  DEBUG_PRN(("\r\n\tchip @ 0x%08X.", m_chip));
